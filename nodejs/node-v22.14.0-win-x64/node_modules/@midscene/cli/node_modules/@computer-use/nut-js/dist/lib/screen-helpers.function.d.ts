import { ColorQuery, Image, MatchRequest, MatchResult, OptionalSearchParameters, Point, PointResultFindInput, Region, RegionResultFindInput, TextQuery } from "@computer-use/shared";
