import { FileType, FindHookCallback, FindInput, FindResult, Image, MatchResultCallback, OptionalSearchParameters, Point, PointResultFindInput, Region, RegionResultFindInput, WindowCallback, WindowResultFindInput } from "@computer-use/shared";
...
export declare class ScreenClass {
     ...
     */
    colorAt(point: Point | Promise<Point>): Promise<import("@computer-use/shared").RGBA>;
    private saveImage;
