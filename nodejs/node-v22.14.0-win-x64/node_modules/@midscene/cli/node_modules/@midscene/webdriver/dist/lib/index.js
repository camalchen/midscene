...
class WebDriverClient {
    ...
    async getWindowSize() {
        ...
        try {
            ...
            debugClient(`Failed to get window rect: ${err}. Falling back to /window/size`);
            try {
                const response = await this.makeRequest('GET', `/session/${this.sessionId}/window/size`);
    ...
    buildSessionEndpoint(endpoint) {
        this.ensureSession();
        if (endpoint.startsWith('/session/')) return endpoint;
